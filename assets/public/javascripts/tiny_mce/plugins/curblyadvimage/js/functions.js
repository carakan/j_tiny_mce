function select_image(element){
    //alert(this);
    //element = $(element);
    //element.next('ul').select('li').removeClass("selected");
    //element.next('li').addClass('selected');
}
function select_thumb(element) {
    var imagen = $("#imagen_" + element);
    curbly_insert_image(imagen.attr('title'), imagen.attr('alt'));
